...
//    }
    ...
    @GetMapping("/patient")
    public String getPatientById(@RequestParam("patId") Long theId, Model theModel, HttpSession session) {
    ...
    public String getPatientAppointments(@RequestParam("patId") Long theId, Model theModel) {
        List<Appointment> theAppointments = appointmentService.getAppointmentsByPatId(theId.intValue());
        theModel.addAttribute("appointments", theAppointments);
...
//        appointment.setDoctor(theDocId);
//        appointment.setPatient(thePatId);
